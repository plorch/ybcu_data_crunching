...
```{r connect}
dsn_database = "postgis_32_ssrs"   # Specify the name of your Database
# Specify host name e.g.:"aws-us-east-1-portal.4.dblayer.com"
dsn_hostname = "localhost"  
dsn_port = "5432"                # Specify your port number. e.g. 5432
dsn_uid = "postgres"         # Specify your username. e.g. "postgres" or "admin"
dsn_pwd = "IpDesh?6"        # Specify your password. e.g. "NEEDTOFILLIN"
