...
summary(R10) # glmer(COBPRB ~ ha + Age + nAges +(1|Site) +(1|Year), data = det, family = poisson)
summary(R2) # glmer(COBPRB ~ ha + Age + cha2 + nAges +(1|Site)+(1|Year), data = det, family = poisson)

# Delta AICc close to 2
summary(R1) # glmer(COBPRB ~ ha + Age + cha2 + nAges + youngest +(1|Site)+(1|Year), data = det, family = poisson)
summary(R9) # glmer(COBPRB ~ ha + Age + nAges + youngest +(1|Site)+(1|Year), data = det, family = poisson)
