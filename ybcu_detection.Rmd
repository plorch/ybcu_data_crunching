...
# Add lines for new sites not in the pre-2019 data set
  ...
  add_row(Site = "CNHFM", Age = 1, contig = 1, big = 0, ha = 49.26, 
          cha = 174.53, cha2 = 174.53, inc = 1, youngest = as.factor(1), 
          nAges = 5) %>%
  add_row(Site = "CNHFN", Age = 5, contig = 1, big = 0, ha = 37.86, 
          cha = 174.53, cha2 = 174.53, inc = 1, youngest =  as.factor(1), 
          nAges = 5) %>%
  add_row(Site = "CVCA09", Age = 1, contig = 1, big = 0, ha = 31.25, 
          cha = 174.53, cha2 = 174.53, inc = 1, youngest =  as.factor(1), 
          nAges = 5) %>%
  mutate(Age19 = Age + 1,
         Age20 = Age + 2,
