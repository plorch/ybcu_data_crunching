...
Transects2019_05Jan23 = read_excel("C:/Users/PatrickLorch/SSRS/Southern Sierra Research Station - Documents/Projects/LCR YBCU/Data/2019-2022 Transects for analysis/2019/Transects2019_05Jan23.xls")
Trans19_sub = Transects2019_05Jan23 %>%
  filter(SiteCode %in% 
           c("CNCR", "CNHF", "CVP1", "CVP2", "CVP3", "CVP7", "CVP8",
             "PVP1", "PVP2", "PVP3", "PVP4", "PVP5",
             "PVP6", "PVP7", "PVP8")) %>%
  separate("SurveyKey",
...
codeconvert = Trans19_sub %>%
  select(SiteCode, loccode1922) %>%
  distinct()
det_sites = unique(det$Site)
codeconvert$SiteCode
# Manually assign names that will match the pre-2019 data
renames = det_sites[c(11, 10, 15, 14, 14, 13, 14, 13, 12, 12, 13,
            9, 5, 1, 1, 4, 6, 6, 15, 16, 3, 7,
            8, 10, 4, 8)]
data.frame(codes = codeconvert$SiteCode, renames)
codeconvert$Site = renames
codeconvert$Site[14] = "CNCRS"
  
loccodes = unique(Trans19_sub$loccode1922)
detvars = det %>%
